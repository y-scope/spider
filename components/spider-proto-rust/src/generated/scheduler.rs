...
pub struct NextTaskResponse {
    #[prost(oneof = "next_task_response::Result", tags = "1, 2")]
    pub result: ::core::option::Option<next_task_response::Result>,
}
/// Nested message and enum types in `NextTaskResponse`.
pub mod next_task_response {
    #[derive(Clone, Copy, PartialEq, ::prost::Oneof)]
    pub enum Result {
        #[prost(message, tag = "1")]
        Assignment(super::SchedulerAssignment),
        #[prost(message, tag = "2")]
        NoTask(super::super::common::Void),
    }
}
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
...
pub mod scheduler_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn next_task(
            &mut self,
            request: impl tonic::IntoRequest<super::NextTaskRequest>,
        ) -> std::result::Result<
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/scheduler.SchedulerService/NextTask",
            );
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/scheduler.SchedulerService/NextTask" => {
                    ...
                    struct NextTaskSvc<T: SchedulerService>(pub Arc<T>);
                    impl<
                        T: SchedulerService,
                    > tonic::server::UnaryService<super::NextTaskRequest>
                    for NextTaskSvc<T> {
                        type Response = super::NextTaskResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as SchedulerService>::next_task(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
