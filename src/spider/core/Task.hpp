...
public:
    ...
    void set_max_retries(unsigned int num_retries) { m_max_retires = num_retries; }
    ...
    [[nodiscard]] auto get_max_retires() const -> unsigned int { return m_max_retires; }
