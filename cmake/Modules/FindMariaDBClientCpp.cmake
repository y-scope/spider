...
find_path(MariaDBClientCpp_INCLUDE_DIR conncpp.hpp
    HINTS ${mariadbclientcpp_PKGCONF_INCLUDEDIR}
...
# Find library
find_library(MariaDBClientCpp_LIBRARY
    NAMES ${mariadbclientcpp_LIBNAME}
    HINTS ${mariadbclientcpp_PKGCONF_LIBDIR}
    PATH_SUFFIXES mariadb
)
...
if(MariaDBClientCpp_USE_STATIC_LIBS)
    FindStaticLibraryDependencies(${mariadbclientcpp_LIBNAME} mariadbclient
...
FindDynamicLibraryDependencies(mariadbclient "${mariadbclientcpp_DYNAMIC_LIBS}")

# Set version
set(MariaDBClientCpp_VERSION ${mariadbclientcpp_PKGCONF_VERSION})

include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(MariaDBClientCpp
    REQUIRED_VARS MariaDBClientCpp_INCLUDE_DIR
...
if(NOT TARGET MariaDBClientCpp::MariaDBClientCpp)
    ...
    if(MariaDBClientCpp_INCLUDE_DIR)
        set_target_properties(MariaDBClientCpp::MariaDBClientCpp
            PROPERTIES
            INTERFACE_INCLUDE_DIRECTORIES "${MariaDBClientCpp_INCLUDE_DIR}"
        )
    endif()
    ...
    if(EXISTS "${MariaDBClientCpp_LIBRARY}")
        set_target_properties(MariaDBClientCpp::MariaDBClientCpp
            ...
            IMPORTED_LOCATION "${MariaDBClientCpp_LIBRARY}"
        )
        ...
        if(mariadbclientcpp_LIBRARY_DEPENDENCIES)
            set_target_properties(MariaDBClientCpp::MariaDBClientCpp
                PROPERTIES
                INTERFACE_LINK_LIBRARIES "${mariadbclientcpp_LIBRARY_DEPENDENCIES}"
            )
        endif()
    endif()
endif()